...
var appIcon = {
  styles: React__default.createElement(_JSXStyle, {
    id: "255544020"
  }, ["svg.jsx-255544020{fill:".concat(uiCore.colors.white, ";cursor:pointer;height:24px;width:24px;}")]),
  className: "jsx-255544020"
};
var trailIcon = {
  styles: React__default.createElement(_JSXStyle, {
    id: "4078879535"
  }, ["svg.jsx-4078879535{fill:".concat(uiCore.colors.grey900, ";cursor:pointer;height:24px;width:24px;margin-right:8px;margin-top:4px;}")]),
  className: "jsx-4078879535"
};
var settingsIcon = {
  styles: React__default.createElement(_JSXStyle, {
    id: "4285170702"
  }, ["svg.jsx-4285170702{margin:8px 8px 0 16px;color:".concat(uiCore.colors.grey900, ";height:24px;width:24px;cursor:pointer;}")]),
...
function Search(_ref2) {
  ...
  return React__default.createElement("div", {
    ...
    onChange: onChange,
    trailIcon: React__default.createElement(TrailIcon, {
      onClick: onIconClick
    }),
    initialFocus: true
  })), React__default.createElement("span", {
  ...
  }))), trailIcon.styles, settingsIcon.styles, React__default.createElement(_JSXStyle, {
    id: "2764723183"
...
function Item(_ref3) {
  ...
  return React__default.createElement("a", {
    href: path,
    className: _JSXStyle.dynamic([["3670725638", [uiCore.theme.primary050]]])
...
function (_React$Component) {
  ...
  function Apps$1() {
    ...
    _defineProperty(_assertThisInitialized(_this), "AppMenu", function (apps) {
      ...
      }, React__default.createElement(uiCore.Card, null, React__default.createElement(Search, {
  ...
  _createClass(Apps$1, [{
    ...
    value: function render() {
      ...
      return React__default.createElement("div", {
        ...
        className: "jsx-1265754857"
      }, React__default.createElement(Apps, {
        className: appIcon.className
      })), this.state.show && this.AppMenu(apps), appIcon.styles, React__default.createElement(_JSXStyle, {
        id: "1265754857"
...
var ProfileDetails = function ProfileDetails(_ref4) {
  ...
  }, React__default.createElement(ProfileName, null, name), React__default.createElement(ProfileEmail, null, email), React__default.createElement(ProfileEdit, {
    contextPath: contextPath
  }, i18n.t('Edit profile')), React__default.createElement(_JSXStyle, {
    id: "3814112749"
...
var ProfileHeader = function ProfileHeader(_ref5) {
  ...
  }, img ? React__default.createElement(ImageIcon, {
    src: img
  }) : React__default.createElement(TextIcon, {
    name: name
  }), React__default.createElement(ProfileDetails, {
    name: name,
    email: email,
    contextPath: contextPath
  }), React__default.createElement(_JSXStyle, {
...
var iconStyle = {
  styles: React__default.createElement(_JSXStyle, {
    id: "2224778647"
  }, ["svg.jsx-2224778647{fill:".concat(uiCore.colors.grey700, ";cursor:pointer;height:24px;width:24px;}")]),
  className: "jsx-2224778647"
};
var list = [{
  icon: React__default.createElement(Settings, {
  ...
  icon: React__default.createElement(Account, {
    className: iconStyle.className
  }),
  ...
  icon: React__default.createElement(Help, {
    className: iconStyle.className
  }),
  label: i18n.t('Help'),
  value: 'help',
  ...
  icon: React__default.createElement(Info, {
    className: iconStyle.className
  }),
  ...
  icon: React__default.createElement(Exit, {
    className: iconStyle.className
  }),
  label: i18n.t('Logout'),
  value: 'logout',
...
var ProfileContents = function ProfileContents(_ref) {
  ...
  return React__default.createElement(uiCore.Card, null, React__default.createElement("div", {
    className: "jsx-374793399"
  }, React__default.createElement(ProfileHeader, {
    name: name,
    email: email,
    img: avatar,
    contextPath: contextPath
  }), React__default.createElement(uiCore.Divider, {
    margin: "13px 0 7px 0"
    ...
    var label = _ref2.label,
        ...
        link = _ref2.link,
        nobase = _ref2.nobase;
    return React__default.createElement(uiCore.MenuItem, {
  ...
  }))), iconStyle.styles, React__default.createElement(_JSXStyle, {
    id: "374793399"
...
var ProfileMenu = function ProfileMenu(_ref3) {
  ...
  }, React__default.createElement(ProfileContents, {
    name: name,
    email: email,
    avatar: avatar,
    contextPath: contextPath
...
function (_React$Component) {
  ...
  _createClass(Profile, [{
    ...
    value: function userIcon(me, contextPath) {
      ...
      if (avatar) {
        return React__default.createElement(ImageIcon, {
          src: avatar,
          onClick: this.onToggle,
    ...
    value: function render() {
      ...
      }, this.userIcon(user, contextPath), this.state.show ? React__default.createElement(ProfileMenu, {
        avatar: avatarPath(user.avatar, contextPath),
        name: user.name,
        email: user.email,
        contextPath: contextPath
      }) : null, React__default.createElement(_JSXStyle, {
        id: "661915851"
...
var LogoImage = function LogoImage() {
  var _useDataQuery = appRuntime.useDataQuery(query),
  ...
  if (!error && pathExists(data)) {
    ...
    Logo = React__default.createElement(uiCore.LogoIconWhite, {
      className: logoStyles.className
    });
  }
  ...
  }, Logo, logoStyles.styles, React__default.createElement(_JSXStyle, {
    id: "3930434724"
...
var Logo = function Logo(_ref) {
  ...
  return React__default.createElement("div", {
    ...
    href: baseUrl,
    className: "jsx-3075771711"
  }, React__default.createElement(LogoImage, null)), React__default.createElement(_JSXStyle, {
    id: "3075771711"
...
var Title = function Title(_ref) {
  ...
  }, app ? "".concat(instance, " - ").concat(app) : "".concat(instance), React__default.createElement(_JSXStyle, {
    id: "2721515324"
...
function icon(kind) {
  if (kind === 'message') {
    ...
    return React__default.createElement(Email, {
...
var NotificationIcon = function NotificationIcon(_ref) {
  ...
  return React__default.createElement("a", {
    href: href,
    "data-test": dataTestId,
    className: _JSXStyle.dynamic([["1854025327", [uiCore.theme.secondary300]]]) + " " + (kind || "")
  }, icon(kind), count > 0 && React__default.createElement("span", {
    "data-test": "".concat(dataTestId, "-count"),
    className: _JSXStyle.dynamic([["1854025327", [uiCore.theme.secondary300]]])
  }, count), React__default.createElement(_JSXStyle, {
    id: "1854025327",
    dynamic: [uiCore.theme.secondary300]
  }, ["a.__jsx-style-dynamic-selector{position:relative;margin:8px 24px 0 0;cursor:pointer;}", "span.__jsx-style-dynamic-selector{z-index:1;position:absolute;top:-6px;right:-10px;width:16px;height:16px;border-radius:50%;background-color:".concat(uiCore.theme.secondary300, ";color:#fff;font-size:9px;font-weight:500;line-height:16px;text-align:center;cursor:inherit;}")]));
};
...
var Notifications = function Notifications(_ref) {
  ...
  }, React__default.createElement(NotificationIcon, {
...
var HeaderBar = function HeaderBar(_ref) {
  ...
  var _useDataQuery = appRuntime.useDataQuery(query$1),
      loading = _useDataQuery.loading,
      error = _useDataQuery.error,
      data = _useDataQuery.data;
  ...
  return React__default.createElement("header", {
    className: _JSXStyle.dynamic([["1335571883", [uiCore.colors.white]]]) + " " + (className || "")
  }, !loading && !error && React__default.createElement(React__default.Fragment, null, React__default.createElement(Logo, {
    baseUrl: data.systemInfo.contextPath
  }), React__default.createElement(Title, {
    app: appName,
    instance: data.systemInfo.systemName
  }), React__default.createElement("div", {
    className: _JSXStyle.dynamic([["1335571883", [uiCore.colors.white]]]) + " " + "right-control-spacer"
...
var ErrorMessage = function ErrorMessage(_ref) {
  ...
  return React__default.createElement("span", {
    ...
    className: _JSXStyle.dynamic([["3198585030", [uiCore.colors.grey800, uiCore.spacers.dp4, uiCore.theme.error]]])
  }, children, React__default.createElement(_JSXStyle, {
    id: "3198585030",
    dynamic: [uiCore.colors.grey800, uiCore.spacers.dp4, uiCore.theme.error]
  }, ["span.__jsx-style-dynamic-selector{font-size:14px;color:".concat(uiCore.colors.grey800, ";margin:").concat(uiCore.spacers.dp4, ";color:").concat(uiCore.theme.error, ";}")]));
};
...
var DisabledSelectionLabel = function DisabledSelectionLabel(_ref) {
  ...
  return React__default.createElement(SingleSelectionLabel, {
    checked: false,
    loading: loading,
    label: label,
...
var SingleSelectionLabel = function SingleSelectionLabel(_ref2) {
  ...
  return React__default.createElement("span", {
    ...
    className: _JSXStyle.dynamic([["321503310", [uiCore.colors.grey900, uiCore.colors.teal700]]]) + " " + (cx({
      checked: checked,
      loading: loading
    }) || "")
  }, label, React__default.createElement(_JSXStyle, {
    id: "321503310",
    dynamic: [uiCore.colors.grey900, uiCore.colors.teal700]
  }, ["span.__jsx-style-dynamic-selector{background:transparent;border-radius:3px;color:".concat(uiCore.colors.grey900, ";cursor:pointer;display:inline-block;font-size:14px;line-height:24px;padding:0 5px;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;white-space:nowrap;}"), ".checked.__jsx-style-dynamic-selector{background:".concat(uiCore.colors.teal700, ";color:white;}"), ".loading.__jsx-style-dynamic-selector{cursor:auto;}"]));
};
...
var LabelContainer = function LabelContainer(_ref3) {
  ...
  return React__default.createElement("div", {
    className: _JSXStyle.dynamic([["495975020", [uiCore.colors.teal200]]]) + " " + (cx({
      highlighted: highlighted
    }) || "")
  }, React__default.createElement("span", {
    className: _JSXStyle.dynamic([["495975020", [uiCore.colors.teal200]]])
  }, children), React__default.createElement(_JSXStyle, {
    id: "495975020",
    dynamic: [uiCore.colors.teal200]
  }, ["div.__jsx-style-dynamic-selector{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;}", "span.__jsx-style-dynamic-selector{display:block;}", ".highlighted.__jsx-style-dynamic-selector{background:".concat(uiCore.colors.teal200, ";padding-right:4px;}")]));
};
...
var Icon = function Icon(_ref4) {
  ...
  if (!hasChildren) {
    return React__default.createElement(Single, {
      dataTest: dataTest
    });
  }

  if (open) {
    return React__default.createElement(FolderOpen, {
      dataTest: dataTest
    });
  }

  return React__default.createElement(FolderClosed, {
    dataTest: dataTest
  });
};
...
var IconizedCheckbox = function IconizedCheckbox(_ref5) {
  ...
  var checkboxLabel = React__default.createElement(React__default.Fragment, null, React__default.createElement("span", {
  ...
  return React__default.createElement(React__default.Fragment, null, React__default.createElement(uiCore.Checkbox, {
    dense: true,
    checked: checked,
    name: name,
    value: value,
...
var Label = function Label(_ref7) {
  ...
  if (disableSelection) {
    return React__default.createElement(LabelContainer, {
      highlighted: highlighted
    }, React__default.createElement(DisabledSelectionLabel, {
      label: displayName,
      loading: loading,
  ...
  if (singleSelection) {
    return React__default.createElement(LabelContainer, {
      highlighted: highlighted
    }, React__default.createElement(SingleSelectionLabel, {
      checked: checked,
      label: displayName,
      onChange: onClick,
      loading: loading
  ...
  return React__default.createElement(LabelContainer, {
    highlighted: highlighted
  }, React__default.createElement(IconizedCheckbox, {
    dataTest: dataTest,
    checked: checked,
    name: "org-unit",
    value: id,
...
var useOpenState = function useOpenState(_ref) {
  ...
  var _useState3 = React.useState(autoExpand || expanded.includes(path)),
...
var LoadingSpinner = function LoadingSpinner() {
  ...
  }, React__default.createElement(uiCore.CircularLoader, {
    small: true,
    className: loadingSpinnerStyles.className
  }), React__default.createElement("style", null, loadingSpinnerStyles.styles), React__default.createElement(_JSXStyle, {
    id: "2503342345"
...
var OrganisationUnitNode = function OrganisationUnitNode(_ref) {
  ...
  var label = React__default.createElement(Label, {
    checked: isSelected,
  ...
  return React__default.createElement(uiCore.Node, {
    dataTest: "".concat(dataTest, "-node"),
    open: open,
    onOpen: onToggleOpen,
    onClose: onToggleOpen,
    component: label,
    icon: loading && React__default.createElement(LoadingSpinner, null)
  }, error && React__default.createElement(ErrorMessage, {
    dataTest: dataTest
  }, i18n.t('Could not load children')), showPlaceholder && React__default.createElement("span", {
    ...
    return React__default.createElement(OrganisationUnitNode, {
      key: childPath,
      autoExpandLoadingError: autoExpandLoadingError,
...
var useExpanded = function useExpanded(initiallyExpanded, onExpand, onCollapse) {
  ...
  var _useState = React.useState(allInitiallyExpandedPaths),
      _useState2 = _slicedToArray(_useState, 2),
...
var OrganisationUnitTree = function OrganisationUnitTree(_ref) {
  ...
  return React__default.createElement("div", {
    "data-test": dataTest
  }, error && React__default.createElement(RootError, {
    error: error,
    dataTest: dataTest
  }), loading && React__default.createElement(RootLoading, {
    dataTest: dataTest
