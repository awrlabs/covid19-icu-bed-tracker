...
import React, { Component, createRef, Children, cloneElement, forwardRef, useRef, useState, useContext, Fragment, createContext } from 'react';
...
var Actions = function Actions(_ref) {
  ...
  return React.createElement("div", {
    ...
    return React.createElement(Action, _extends({
      key: action.label
    }, action, {
      hide: hide,
...
var Dismiss = function Dismiss(_ref) {
  ...
  }, React.createElement(Close, null), React.createElement(_JSXStyle, {
    id: "4165464483",
...
var StatusIcon = function StatusIcon(_ref6) {
  ...
  if (valid) {
    return React.createElement(Valid, {
      className: className
    });
  }
...
var Icon = function Icon(_ref) {
  ...
  }, React.isValidElement(icon) ? icon : React.createElement(StatusIcon, {
    valid: success,
    error: critical,
    warning: warning,
    info: info
  ...
  function Button() {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleClick", function (e) {
      if (_this.props.onClick) {
        _this.props.onClick(_this.createHandlerPayload(), e);
      }
    });
...
function Regular(_ref) {
  ...
  }, commonStyles), React.createElement(_JSXStyle, {
    id: "3549931073",
...
function (_Component) {
  ...
  _createClass(Checkbox, [{
    ...
    value: function render() {
      ...
      }, dense ? React.createElement(Dense, {
        className: classes
      }) : React.createElement(Regular, {
        className: classes
...
var AddRequired = function AddRequired(_ref) {
  var label = _ref.label,
      ...
      dataTest = _ref.dataTest;
  return React.createElement(React.Fragment, null, label, required && React.createElement(Required, {
...
var ToggleField = function ToggleField(_ref) {
  ...
  }), helpText && React.createElement(Help, {
    dataTest: "".concat(dataTest, "-help")
  }, helpText), validationText && React.createElement(Help, {
    error: error,
    warning: warning,
    valid: valid,
...
var Legend = function Legend(_ref) {
  ...
  }, children, required && React.createElement(Required, {
    dataTest: "".concat(dataTest, "-required")
  }), React.createElement(_JSXStyle, {
    id: "945530629",
...
var ToggleGroupField = function ToggleGroupField(_ref) {
  ...
  return React.createElement(Field, {
    classname: className,
    dataTest: dataTest
  }, React.createElement(FieldSet, null, label && React.createElement(Legend, {
    required: required
  }, label), React.createElement(ToggleGroup, {
    onChange: onChange,
    name: name,
    value: value,
    className: className,
    ...
    error: error,
    dense: dense
  }, children), helpText && React.createElement(Help, {
    dataTest: "".concat(dataTest, "-help")
  }, helpText), validationText && React.createElement(Help, {
    error: error,
    warning: warning,
...
var CheckboxGroupField = function CheckboxGroupField(_ref) {
  var children = _ref.children,
      ...
      required = _ref.required,
      dataTest = _ref.dataTest;
  return React.createElement(ToggleGroupField, {
    onChange: onChange,
    name: name,
    value: value,
    className: className,
...
var Remove = function Remove(_ref) {
  ...
  }), removeIcon.styles, React.createElement(_JSXStyle, {
...
var Divider = function Divider(_ref) {
  ...
  }, ["div.__jsx-style-dynamic-selector{display:inline-block;width:100%;height:1px;background-color:".concat(colors.grey300, ";}")]), React.createElement(_JSXStyle, {
    id: "3486645161",
  ...
  _createClass(FileInput, [{
    ...
    value: function render() {
      ...
      return React.createElement("div", {
        ...
        tabIndex: tabIndex,
        type: "button"
      }, buttonLabel), React.createElement(StatusIcon, {
        error: error,
        valid: valid,
        warning: warning
      }), React.createElement(_JSXStyle, {
...
var FileInputField = function FileInputField(_ref) {
  ...
  return React.createElement(Field, {
    ...
    disabled: disabled,
    htmlFor: name
  }, label), React.createElement(FileInput, {
    accept: accept,
    ...
    valid: valid,
    dataTest: "".concat(dataTest, "-validation")
  }, validationText), React.createElement(FileList, null, !children && placeholder ? React.createElement(FileListPlaceholder, null, placeholder) : children));
};
...
var FileListItem = function FileListItem(_ref) {
  ...
  }, loading ? React.createElement(Loading, null) : React.createElement(AttachFile, null)), React.createElement("span", {
  ...
  }, label), loading && onCancel && cancelText && React.createElement("span", {
  ...
  }, cancelText), !loading && React.createElement("span", {
    onClick: function onClick(event) {
      return onRemove({}, event);
    },
    "data-test": "".concat(dataTest, "-remove"),
    className: _JSXStyle.dynamic([["2923643952", [spacers.dp4, colors.grey900, colors.grey700]]]) + " " + "action"
  }, removeText)), React.createElement(_JSXStyle, {
    id: "2923643952",
...
var FileListItemWithRemove =
/*#__PURE__*/
function (_Component) {
  _inherits(FileListItemWithRemove, _Component);

  function FileListItemWithRemove() {
    var _getPrototypeOf2;

    var _this;

    _classCallCheck(this, FileListItemWithRemove);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(FileListItemWithRemove)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(FileListItemWithRemove, [{
    key: "render",
    value: function render() {
      var _this$props2 = this.props,
          label = _this$props2.label,
          removeText = _this$props2.removeText,
          className = _this$props2.className;
...
var FileInputFieldWithList =
/*#__PURE__*/
function (_Component) {
  _inherits(FileInputFieldWithList, _Component);

  function FileInputFieldWithList() {
    var _getPrototypeOf2;

    var _this;

    _classCallCheck(this, FileInputFieldWithList);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(FileInputFieldWithList)).call.apply(_getPrototypeOf2, [this].concat(args)));

    _defineProperty(_assertThisInitialized(_this), "handleChange", function (_ref, event) {
      var fileList = _ref.files;
      var _this$props = _this.props,
          onChange = _this$props.onChange,
          name = _this$props.name;
      onChange({
        files: _this.updateFileArray(fileList),
        name: name
      }, event);
    });

    _defineProperty(_assertThisInitialized(_this), "handleRemove", function (_ref2, event) {
      var fileToRemove = _ref2.file;
  ...
  _createClass(FileInputFieldWithList, [{
    key: "updateFileArray",
     ...
     * @returns {File[]}
     */
    value: function updateFileArray(fileList) {
      var _this$props3 = this.props,
          multiple = _this$props3.multiple,
          files = _this$props3.files; // Spread immutable FileList instance onto array

      var newFiles = _toConsumableArray(fileList);
      ...
      return files.filter(function (file) {
        return !newFiles.some(function (x) {
          return x.name === file.name && x.lastModified === file.lastModified && x.size === file.size && x.type === file.type;
        });
      }).concat(newFiles);
    }
  }, {
    ...
    value: function render() {
      ...
      var _this$props4 = this.props,
          ...
          removeText = _this$props4.removeText,
          required = _this$props4.required,
          small = _this$props4.small,
          tabIndex = _this$props4.tabIndex,
          valid = _this$props4.valid,
          validationText = _this$props4.validationText,
          warning = _this$props4.warning;
      return React.createElement(FileInputField, {
        accept: accept,
        buttonLabel: buttonLabel,
        className: className,
        dataTest: dataTest,
        ...
        return React.createElement(FileListItemWithRemove, {
          key: file.name,
          label: file.name,
          removeText: removeText,
  ...
  _createClass(Input, [{
    ...
    value: function render() {
      ...
      return React.createElement("div", {
        ...
        id: styles$1.__hash
      }, styles$1), React.createElement(_JSXStyle, {
        id: "3353877153"
  ...
  _createClass(InputField, [{
    ...
    value: function render() {
      ...
      return React.createElement(Field, {
        ...
        disabled: disabled,
        htmlFor: name
      }, label), React.createElement(Constrictor, {
        width: inputWidth,
        minWidth: "72px"
      }, React.createElement(Input, {
        onFocus: onFocus,
...
var Progress = function Progress(_ref) {
  ...
  return React.createElement("div", {
    ...
    id: "686723300",
    dynamic: [amount]
  }, ["div.__jsx-style-dynamic-selector{width:".concat(amount, "%;}")]), React.createElement(_JSXStyle, {
    id: "3243380718",
...
var LogoIcon = function LogoIcon(_ref) {
  var className = _ref.className,
      dataTest = _ref.dataTest;
  return React.createElement(LogoIconSvg, {
    iconColor: blue,
    className: className,
    dataTest: dataTest
  });
...
var Logo = function Logo(_ref3) {
  ...
  return React.createElement(LogoSvg, {
    iconColor: blue,
    textColor: dark,
    className: className,
    dataTest: dataTest
...
var _defaultExport$2 = ["li.jsx-1729285861{position:relative;padding:0;cursor:pointer;list-style:none;}", "li.jsx-1729285861 div.label.jsx-1729285861:not(:first-child){margin-left:".concat(spacers.dp8, ";}"), "li.jsx-1729285861:hover{background-color:".concat(colors.grey200, ";}"), "li.jsx-1729285861:active,li.active.jsx-1729285861{background-color:".concat(colors.grey400, ";}"), ".dense.jsx-1729285861 .link.jsx-1729285861{padding:".concat(spacers.dp8, " ").concat(spacers.dp12, ";}"), ".dense.jsx-1729285861 .label.jsx-1729285861{font-size:14px;line-height:16px;}", ".dense.jsx-1729285861 .icon.jsx-1729285861{font-size:20px;}", ".disabled.jsx-1729285861{cursor:not-allowed;pointer-events:none;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;}", ".disabled.jsx-1729285861 .icon.jsx-1729285861,.disabled.jsx-1729285861 .label.jsx-1729285861{color:".concat(colors.grey500, ";}"), ".destructive.jsx-1729285861 .label.jsx-1729285861{color:".concat(colors.red700, ";}"), ".destructive.jsx-1729285861 .icon.jsx-1729285861{color:".concat(colors.red600, ";}"), "li.destructive.jsx-1729285861:hover{background-color:".concat(colors.red050, ";}"), "li.destructive.jsx-1729285861:active{background-color:".concat(colors.red100, ";}"), ".link.jsx-1729285861{display:block;height:100%;padding:15px ".concat(spacers.dp24, ";-webkit-text-decoration:none;text-decoration:none;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-flex-direction:row;-ms-flex-direction:row;flex-direction:row;-webkit-align-items:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;}"), ".label.jsx-1729285861{color:".concat(colors.grey900, ";font-size:15px;line-height:18px;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;}"), ".icon.jsx-1729285861{box-sizing:border-box;margin-right:".concat(spacers.dp16, ";color:#404040;font-size:24px;pointer-events:none;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;}")];
_defaultExport$2.__hash = "1729285861";
...
var MenuItemContent = forwardRef(function (_ref, ref) {
  var href = _ref.href,
  ...
  var linkElementProps = isClickable ? {
    href: href,
  ...
  }, label), showChevron && React.createElement(ChevronRight, {
...
var baseModifiers = /*#__PURE__*/Object.freeze({
    __proto__: null,
...
function (_Component) {
  ...
  function Popper() {
    ...
    _defineProperty(_assertThisInitialized(_this), "popperInstance", null);

    _defineProperty(_assertThisInitialized(_this), "popperRef", createRef());
  ...
  _createClass(Popper, [{
    ...
    value: function componentDidMount() {
      ...
      this.popperInstance = createPopper(reference.current, this.popperRef.current, {
        strategy: strategy,
    ...
    key: "deduplicateModifiers",
    value: function deduplicateModifiers() {
      var modifiers = this.props.modifiers; // Deduplicate modifiers from props and baseModifiers,
      // when duplicates are encountered (by name), use the
      // modifier from props so each Popper can be fully custom

      return Object.keys(baseModifiers).map(function (key) {
        return baseModifiers[key];
...
Popper.propTypes = {
  ...
  modifiers: propTypes$1.arrayOf(propTypes$1.shape({
    name: propTypes$1.string,
    options: propTypes$1.object
  })),
  placement: referencePlacementPropType,
  strategy: propTypes$1.oneOf(['absolute', 'fixed']),
  // defaults to 'absolute'
  onFirstUpdate: propTypes$1.func
};

var createMenuItemMouseOutHandler = function createMenuItemMouseOutHandler(setOpen, popperRef) {
...
var createPopperMouseOutHandler = function createPopperMouseOutHandler(setOpen, menuItemRef, popperRef) {
  return function (event) {
    if (!menuItemRef.current.contains(event.relatedTarget) && !popperRef.current.contains(event.relatedTarget)) {
      setOpen(false);
    }
  };
};
...
var SubMenu = function SubMenu(_ref) {
  ...
  return React.createElement(React.Fragment, null, React.createElement(MenuItemContent, {
    active: active,
    className: className,
    dataTest: dataTest,
    dense: dense,
    ...
    ref: popperRef,
    onMouseOut: createPopperMouseOutHandler(setOpen, menuItemRef, popperRef)
  }, children)));
};
...
var MenuItem = function MenuItem(_ref) {
  var href = _ref.href,
      ...
      target = _ref.target,
      dataTest = _ref.dataTest;
  return !children ? React.createElement(MenuItemContent, {
    active: active,
    className: className,
    dataTest: dataTest,
    dense: dense,
...
var LayerContext = React.createContext(0);
...
var Backdrop = function Backdrop(_ref) {
  ...
  return React.createElement(Layer, {
    ...
    return React.createElement("div", {
      ...
      id: "210289875"
    }, [".backdrop.jsx-210289875{position:fixed;height:100%;width:100%;left:0;top:0;}"]), React.createElement(_JSXStyle, {
      id: "3423950975",
...
var Arrow = function Arrow(_ref) {
  ...
  return React.createElement("div", {
    ...
    className: _JSXStyle.dynamic([["2122212195", [ARROW_SIZE, ARROW_SIZE, ARROW_SIZE / 2, ARROW_SIZE / 2, ARROW_SIZE / 2, ARROW_SIZE / 2, ARROW_SIZE / 2, colors.white, colors.white]]]) + " " + (className || "")
  }, React.createElement(_JSXStyle, {
    id: "2122212195",
    dynamic: [ARROW_SIZE, ARROW_SIZE, ARROW_SIZE / 2, ARROW_SIZE / 2, ARROW_SIZE / 2, ARROW_SIZE / 2, ARROW_SIZE / 2, colors.white, colors.white]
  }, ["div.__jsx-style-dynamic-selector{pointer-events:none;width:".concat(ARROW_SIZE, "px;height:").concat(ARROW_SIZE, "px;}"), "[data-popper-placement^='top'] div.__jsx-style-dynamic-selector{bottom:-".concat(ARROW_SIZE / 2, "px;}"), "[data-popper-placement^='bottom'] div.__jsx-style-dynamic-selector{top:-".concat(ARROW_SIZE / 2, "px;}"), "[data-popper-placement^='left'] div.__jsx-style-dynamic-selector{right:-".concat(ARROW_SIZE / 2, "px;}"), "[data-popper-placement^='right'] div.__jsx-style-dynamic-selector{left:-".concat(ARROW_SIZE / 2, "px;}"), "[data-popper-arrow-displaced] div.__jsx-style-dynamic-selector{visibility:hidden;}", "div.__jsx-style-dynamic-selector::after{content:'';position:absolute;pointer-events:none;box-sizing:border-box;border-style:solid;border-width:".concat(ARROW_SIZE / 2, "px;border-color:transparent transparent ").concat(colors.white, " ").concat(colors.white, ";box-shadow:-1px 1px 1px 0 rgba(64,75,90,0.08), -3px 3px 8px -6px rgba(64,75,90,0.15);}"), "[data-popper-placement^='top'] div.__jsx-style-dynamic-selector::after{-webkit-transform:rotate(-45deg);-ms-transform:rotate(-45deg);transform:rotate(-45deg);}", "[data-popper-placement^='bottom'] div.__jsx-style-dynamic-selector::after{-webkit-transform:rotate(135deg);-ms-transform:rotate(135deg);transform:rotate(135deg);}", "[data-popper-placement^='left'] div.__jsx-style-dynamic-selector::after{-webkit-transform:rotate(-135deg);-ms-transform:rotate(-135deg);transform:rotate(-135deg);}", "[data-popper-placement^='right'] div.__jsx-style-dynamic-selector::after{-webkit-transform:rotate(45deg);-ms-transform:rotate(45deg);transform:rotate(45deg);}"]));
};
...
var computeArrowPadding = function computeArrowPadding() {
  // pythagoras
  var diagonal = Math.sqrt(2 * Math.pow(ARROW_SIZE, 2));
  var overflowInPx = (diagonal - ARROW_SIZE) / 2;
  var padding = BORDER_RADIUS + overflowInPx;
...
var hideArrowWhenDisplaced = {
  name: 'hideArrowWhenDisplaced',
  enabled: true,
  phase: 'main',
  fn: function fn(_ref) {
    var state = _ref.state;
    var halfArrow = ARROW_SIZE / 2;
    var displacement = state.modifiersData.preventOverflow;
    var referenceRect = state.rects.reference;
    var shouldHideArrow = Math.abs(displacement.x) >= referenceRect.width + halfArrow || Math.abs(displacement.y) >= referenceRect.height + halfArrow;
...
var arroModifiers = [arrow, offset, hideArrowWhenDisplaced];
/**
 * @module
...
var Popover = function Popover(_ref) {
  ...
  return createPortal(React.createElement(Backdrop, {
    ...
    className: _JSXStyle.dynamic([["633543275", [maxWidth, elevation, colors.white]]])
  }, children, arrow && React.createElement(Arrow, null), React.createElement(_JSXStyle, {
    id: "633543275",
    dynamic: [maxWidth, elevation, colors.white]
  }, ["div.__jsx-style-dynamic-selector{max-width:".concat(maxWidth, "px;box-shadow:").concat(elevation, ";background-color:").concat(colors.white, ";border-radius:4px;}")])))), document.body);
};
...
Popover.propTypes = {
  ...
  placement: referencePlacementPropType,
  onBackdropClick: propTypes$1.func
};
...
function Regular$1(_ref) {
  ...
  return React.createElement("svg", {
    ...
    id: "1260643562"
  }, ["svg.jsx-1260643562{height:18px;width:18px;}"]), React.createElement(_JSXStyle, {
    id: styles$2.__hash
  }, styles$2));
}
Regular$1.propTypes = {
...
function Dense$1(_ref2) {
  ...
  return React.createElement("svg", {
    ...
    id: "1659897952"
  }, ["svg.jsx-1659897952{height:14px;width:14px;}"]), React.createElement(_JSXStyle, {
    id: styles$2.__hash
  }, styles$2));
}
Dense$1.propTypes = {
...
function (_Component) {
  ...
  _createClass(Radio, [{
    ...
    value: function render() {
      ...
      }, dense ? React.createElement(Dense$1, {
        className: classes
      }) : React.createElement(Regular$1, {
        className: classes
      })), label, React.createElement(_JSXStyle, {
        id: "2400462603",
        dynamic: [colors.grey900, theme.disabled, colors.blue600]
...
var Content$1 = function Content(_ref) {
  ...
  return React.createElement("div", {
    className: _JSXStyle.dynamic([["2318048676", [spacers.dp64, spacers.dp64]]]) + " " + (position || "")
  }, children, React.createElement(_JSXStyle, {
    id: "2318048676",
    dynamic: [spacers.dp64, spacers.dp64]
  }, ["div.__jsx-style-dynamic-selector{position:absolute;left:50%;width:auto;height:auto;}", ".top.__jsx-style-dynamic-selector{top:".concat(spacers.dp64, ";}"), ".middle.__jsx-style-dynamic-selector{top:50%;-webkit-transform:translate(-50%,-50%);-ms-transform:translate(-50%,-50%);transform:translate(-50%,-50%);}", ".bottom.__jsx-style-dynamic-selector{top:auto;bottom:".concat(spacers.dp64, ";}")]));
};
...
function (_Component) {
  ...
  function TextArea() {
    ...
    _defineProperty(_assertThisInitialized(_this), "textareaRef", React.createRef());
  ...
  _createClass(TextArea, [{
    ...
    value: function render() {
      ...
      return React.createElement("div", {
        ...
        id: styles$4.__hash
      }, styles$4), React.createElement(_JSXStyle, {
        id: "3036048772",
...
var MenuWrapper = function MenuWrapper(_ref) {
  ...
  return ReactDOM.createPortal(React.createElement(Backdrop, {
    onClick: onClick,
    transparent: true,
  ...
  }, children), styles, React.createElement(_JSXStyle, {
    id: "3936600096",
    dynamic: [menuWidth]
  }, ["div.__jsx-style-dynamic-selector{width:".concat(menuWidth, ";}")])))), document.body);
};
...
function (_Component) {
  ...
  _createClass(Select, [{
    ...
    value: function componentDidMount() {
      ...
      this.setState({
        menuWidth: "".concat(this.inputRef.current.offsetWidth, "px")
      });
    }
  }, {
    key: "render",
    value: function render() {
      ...
      var input = React.cloneElement(this.props.input, inputProps); // Create the menu
      ...
      var menu = React.cloneElement(this.props.menu, menuProps);
      return React.createElement("div", {
        className: className,
        ref: this.selectRef,
      ...
      }, input), open && React.createElement(MenuWrapper, {
...
var findOptionChild = function findOptionChild(targetOption, optionChildren) {
  return React.Children.toArray(optionChildren).find(function (currentOption) {
...
var InputPlaceholder = function InputPlaceholder(_ref) {
  ...
  }, placeholder, React.createElement(_JSXStyle, {
    id: "1027033961",
...
var InputPrefix = function InputPrefix(_ref) {
  ...
  }, prefix, React.createElement(_JSXStyle, {
    id: "153011991",
...
var Empty = function Empty(_ref) {
  ...
  }, message, React.createElement(_JSXStyle, {
    id: "849993029",
...
var Menu = function Menu(_ref) {
  ...
  var children = React.Children.map(options, function (child) {
  ...
  _createClass(FilterableMenu, [{
    ...
    value: function render() {
      ...
      if (React.Children.count(renderedOptions) === 0 || !filter) {
        return React.createElement(React.Fragment, null, React.createElement(FilterInput, {
      ...
      var filtered = React.Children.map(options, function (child) {
      ...
      var hasMatch = React.Children.count(filtered) > 0;
      return React.createElement(React.Fragment, null, React.createElement(FilterInput, {
        dataTest: "".concat(dataTest, "-filterinput"),
        placeholder: placeholder,
        value: filter,
        onChange: this.onFilterChange
      }), hasMatch ? React.createElement(Menu, _extends({}, menuProps, {
        options: filtered
...
var FilterableMenu$1 = function FilterableMenu$1(_ref) {
  ...
  return React.createElement(FilterableMenu, {
    dataTest: dataTest,
    options: options,
    onChange: onChange,
    selected: selected,
...
var SingleSelect = function SingleSelect(_ref) {
  ...
  var menu = filterable ? React.createElement(FilterableMenu$1, {
    dataTest: dataTest,
    empty: empty,
    noMatchText: noMatchText,
  ...
  return React.createElement("div", {
    ...
    initialFocus: initialFocus,
    dense: dense
  }, children, loading && React.createElement(Loading$1, {
    message: loadingText,
...
var SelectionList = function SelectionList(_ref2) {
  ...
  return React.createElement(React.Fragment, null, selected.map(function (_ref3) {
...
var MultiSelect = function MultiSelect(_ref) {
  var className = _ref.className,
      ...
      dataTest = _ref.dataTest;
  // If the select is filterable, use a filterable menu
  var menu = filterable ? React.createElement(FilterableMenu$2, {
    dataTest: dataTest,
    empty: empty,
    noMatchText: noMatchText,
    placeholder: filterPlaceholder
  ...
  return React.createElement("div", {
    ...
    className: className,
    selected: selected,
    input: React.createElement(Input$2, {
      clearable: clearable,
      clearText: clearText,
      dataTest: dataTest,
      placeholder: placeholder,
...
var MultiSelectOption = function MultiSelectOption(_ref) {
  ...
  return React.createElement("div", {
    ...
    disabled: disabled,
    dense: true
  }), styles$5, React.createElement(_JSXStyle, {
    id: "3813980210",
...
var ContentWithTitle = function ContentWithTitle(_ref) {
  var title = _ref.title,
      children = _ref.children;
  return React.createElement(Fragment, null, title && React.createElement("span", {
...
var extractRowsFromTableChildren = function extractRowsFromTableChildren(children) {
  return React.Children.toArray(children).filter(isChildTableHead) // extract table head children (rows)
...
var StackedTableRow = function StackedTableRow(_ref) {
  ...
  }, React.createElement(Consumer, null, function (_ref2) {
...
var StackedTableRowHead = function StackedTableRowHead(_ref) {
  var children = _ref.children,
      className = _ref.className,
      dataTest = _ref.dataTest;
  return React.createElement(StackedTableRow, {
    className: className,
    dataTest: dataTest
  }, children);
};
  ...
  _createClass(DropdownButton, [{
    ...
    value: function render() {
      ...
      return React.createElement("div", {
        ...
        type: type,
        initialFocus: initialFocus
      }, children, React.createElement(ArrowIconComponent, {
        className: "jsx-3163060161" + " " + (arrow$1.className )
      })), open && createPortal(React.createElement(Backdrop, {
        onClick: this.onToggle,
        transparent: true
      }, React.createElement(Popper, {
        dataTest: "".concat(dataTest, "-popper"),
      ...
      }, component)), document.body), arrow$1.styles, React.createElement(_JSXStyle, {
        id: "3163060161"
...
var Menu$2 = function Menu(_ref) {
  ...
  return React.createElement("div", {
    "data-test": dataTest,
    className: _JSXStyle.dynamic([["3166183617", [spacers.dp4]], ["2538249281", [maxWidth]]]) + " " + (className || "")
  }, React.createElement(Card, null, React.createElement("div", {
    className: _JSXStyle.dynamic([["3166183617", [spacers.dp4]], ["2538249281", [maxWidth]]]) + " " + "menu-list-wrapper"
  }, React.createElement(MenuList, null, children))), React.createElement(_JSXStyle, {
    id: "3166183617",
    dynamic: [spacers.dp4]
  }, [".menu-list-wrapper.__jsx-style-dynamic-selector{padding:".concat(spacers.dp4, " 0;}"), "div.__jsx-style-dynamic-selector{display:inline-block;min-width:128px;}"]), React.createElement(_JSXStyle, {
    id: "2538249281",
    dynamic: [maxWidth]
  }, ["div.__jsx-style-dynamic-selector{max-width:".concat(maxWidth, ";}")]));
};
...
var ArrowDown$2 = function ArrowDown() {
  return React.createElement("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 48 48",
...
var Toggle = function Toggle(_ref) {
  ...
  }, React.createElement(ArrowDown$2, null)), React.createElement(_JSXStyle, {
    id: "486382662",
...
var Node = function Node(_ref) {
  var open = _ref.open,
      ...
      onClose = _ref.onClose,
      dataTest = _ref.dataTest;
  var hasLeaves = !!React.Children.toArray(children).filter(function (i) {
    return i;
  }).length;
  ...
  }, icon), showArrow && React.createElement(Toggle, {
    open: open,
    onOpen: onOpen,
    onClose: onClose,
    dataTest: "".concat(dataTest, "-toggle")
  }), showSpacer && React.createElement(Spacer$1, null), React.createElement("div", {
    "data-test": "".concat(dataTest, "-content"),
    className: "jsx-1433072554"
  }, React.createElement("div", {
    "data-test": "".concat(dataTest, "-label"),
    className: "jsx-1433072554"
  }, label), React.createElement(Leaves, {
    open: open,
...
var cardBoxStyle = {
  styles: React.createElement(_JSXStyle, {
    id: "4018175137"
  }, [".modal-card.jsx-4018175137{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-flex-direction:column;-ms-flex-direction:column;flex-direction:column;height:auto;left:50%;max-height:calc(100vh - ".concat(2 * spacersNum.dp64, "px);max-width:calc(100vw - ").concat(2 * spacersNum.dp64, "px);position:absolute;width:600px;}"), ".top.jsx-4018175137{top:0;-webkit-transform:translate(-50%,0);-ms-transform:translate(-50%,0);transform:translate(-50%,0);}", ".middle.jsx-4018175137{-webkit-transform:translate(-50%,-50%);-ms-transform:translate(-50%,-50%);transform:translate(-50%,-50%);}", ".bottom.jsx-4018175137{bottom:0;-webkit-transform:translate(-50%,0);-ms-transform:translate(-50%,0);transform:translate(-50%,0);}", ".small.jsx-4018175137{width:400px;}", ".large.jsx-4018175137{width:800px;}"]),
  className: "jsx-4018175137"
};
/**
 * @module
 * @private
...
var Modal = function Modal(_ref) {
  var children = _ref.children,
      ...
      position = _ref.position,
      dataTest = _ref.dataTest;
  return createPortal(React.createElement(ScreenCover, {
    onClick: onClose,
    className: className,
    position: position
  ...
  _createClass(SplitButton, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          dataTest = _this$props.dataTest,
          initialFocus = _this$props.initialFocus;
      var arrow = open ? React.createElement(ArrowUp, null) : React.createElement(ArrowDown$1, null);
      return React.createElement("div", {
        ref: this.anchorRef,
        "data-test": dataTest,
        ...
        dataTest: "".concat(dataTest, "-toggle")
      }, arrow), open && createPortal(React.createElement(Backdrop, {
        onClick: this.onToggle,
        transparent: true
      }, React.createElement(Popper, {
        dataTest: "".concat(dataTest, "-menu"),
        placement: "bottom-end",
        reference: this.anchorRef
      }, component)), document.body), rightButton.styles, React.createElement(_JSXStyle, {
        id: "4260486793"
...
function (_Component) {
  ...
  function ScrollBar() {
    ...
    _defineProperty(_assertThisInitialized(_this), "scrollBox", createRef());

    _defineProperty(_assertThisInitialized(_this), "scrollArea", createRef());
  ...
  _createClass(ScrollBar, [{
    ...
    value: function render() {
      ...
      }, React.createElement(ChevronRight, null)), React.createElement(_JSXStyle, {
        id: "4061674243"
...
export { AlertBar, AlertStack, Button, ButtonStrip, Card, Checkbox, CheckboxField, CheckboxGroup, CheckboxGroupField, Chip, CircularLoader, ComponentCover, Constrictor, CssReset, CssVariables, Divider, DropdownButton, Field, FieldSet, FileInput, FileInputField, FileInputFieldWithList, FileList, FileListItem, FileListPlaceholder, Help, Input, InputField, Label, Legend, LinearLoader, Logo, LogoIcon, LogoIconWhite, LogoWhite, Menu$2 as Menu, MenuItem, MenuList, Modal, ModalActions, ModalContent, ModalTitle, MultiSelect, MultiSelectField, MultiSelectOption, Node, Popover, Popper, Radio, RadioGroup, RadioGroupField, ScreenCover, SingleSelect, SingleSelectField, SingleSelectOption, SplitButton, StackedTable, StackedTableBody, StackedTableCell, StackedTableCellHead, StackedTableFoot, StackedTableHead, StackedTableRow, StackedTableRowHead, Switch, SwitchField, SwitchGroup, SwitchGroupField, Tab, TabBar, Table, TableBody, TableCell, TableCellHead, TableFoot, TableHead, TableRow, TableRowHead, Tag, TextArea, TextAreaField, colors, elevations, layers, spacers, theme };
