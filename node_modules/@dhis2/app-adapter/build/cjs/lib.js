...
var LoginModal = function LoginModal() {
  ...
  return React__default.createElement(uiCore.Modal, {
    ...
    onSubmit: onSubmit
  }, React__default.createElement(uiCore.ModalTitle, null, i18n.t('Please sign in')), React__default.createElement(uiCore.ModalContent, null, !staticUrl && React__default.createElement(uiCore.InputField, {
  ...
  })), React__default.createElement(uiCore.ModalActions, null, React__default.createElement(uiCore.Button, {
    primary: true,
    type: "submit"
  }, i18n.t('Sign in')))));
};
...
var App = function App(_ref) {
  var url = _ref.url,
      ...
      children = _ref.children;
  return React__default.createElement(FatalErrorBoundary, null, React__default.createElement(appRuntime.Provider, {
    config: {
      baseUrl: url,
    ...
    id: styles.__hash
  }, styles), React__default.createElement(uiWidgets.HeaderBar, {
    appName: appName
