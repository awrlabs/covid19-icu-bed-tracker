...
import { Modal, ModalTitle, ModalContent, InputField, ModalActions, Button, ScreenCover, CircularLoader } from '@dhis2/ui-core';
...
var LoginModal = function LoginModal() {
  ...
  return React.createElement(Modal, {
    ...
    onSubmit: onSubmit
  }, React.createElement(ModalTitle, null, i18n.t('Please sign in')), React.createElement(ModalContent, null, !staticUrl && React.createElement(InputField, {
...
var App = function App(_ref) {
  var url = _ref.url,
      ...
      children = _ref.children;
  return React.createElement(FatalErrorBoundary, null, React.createElement(Provider, {
    config: {
      baseUrl: url,
    ...
    id: styles.__hash
  }, styles), React.createElement(HeaderBar, {
    appName: appName
